...
@section('content')
    ...
    @php
        $adminStatuses = ['pending', 'in_progress', 'verification', 'rework', 'delayed', 'cancelled', 'done'];
    @endphp

    <div class="pagetitle">
        <h1 class="mb-1">Monitoring Jobdesk</h1>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0">
                <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Home</a></li>
                <li class="breadcrumb-item">Admin</li>
                <li class="breadcrumb-item active" aria-current="page">Monitoring Jobdesk</li>
            </ol>
        </nav>
    </div>
                            ...
                            <div class="row g-2 g-md-3 align-items-end">
                                ...
                                <div class="col-12 col-sm-6 col-md-3">
                                    ...
                                    <select name="division" class="form-select">
                                        ...
                                        <option value="Customer Service" @selected($div === 'Customer Service')>Customer Service
                                        </option>
                                    </select>
                                </div>
                        ...
                        <form id="bulkForm" action="{{ route('admin.jobdesk.bulk') }}" method="POST" class="mt-3">
                            ...
                            <div class="d-flex flex-wrap align-items-center gap-2">
                                ...
                                <select name="action" class="form-select form-select-sm" style="max-width:220px;" required>
                                    ...
                                    @foreach ($adminStatuses as $opt)
                                        <option value="status:{{ $opt }}">Ubah ke
                            ...
                            <div class="table-responsive mt-3">
                                <table class="table table-sm align-middle" id="tableJobdeskAdmin">
                                    ...
                                    <tbody>
                                        @forelse($rows as $i => $t)
                                            @php
                                                $no = method_exists($rows, 'firstItem')
                                                    ? $rows->firstItem() + $i
                                                    : $i + 1;
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <span
                                                        class="badge bg-info text-dark text-wrap">{{ $div }}</span>
                                                </td>
                                                ...
                                                <td class="text-end">
                                                    <div class="btn-group">
                                                        ...
                                                        <button type="button"
                                                            ...
                                                            data-bs-toggle="modal" data-bs-target="#modalDetailJobdesk"
                                                            data-title="{{ $judul }}"
                                                            data-date="{{ $tgl }}"
                                                            data-time="{{ $time }}"
                                                            data-nama="{{ $nama }}"
                                                        ...
                                                        {{-- ✅ EDIT --}}
                                                        <button type="button"
                                                            class="btn btn-sm btn-outline-secondary open-edit"
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <select name="status" id="eStatus" class="form-select" required>
                                @foreach ($adminStatuses as $opt)
                                    <option value="{{ $opt }}">{{ ucwords(str_replace('_', ' ', $opt)) }}
                                    </option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="col-md-8">
                            ...
                            <input type="url" name="proof_link" id="eProofLink" class="form-control"
                                placeholder="https://...">
                        </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            modalDetail?.addEventListener('show.bs.modal', function(e) {
                ...
                document.getElementById('dProgress').innerText = (btn.getAttribute('data-progress') ||
                    '0') + '%';
